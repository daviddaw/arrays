...
public class Principal {
	...
	public static void rellenarAlumnos(Alumnos[] arrAlumnos) {
		for (int i = 0; i < arrAlumnos.length; i++) {
			// arrAlumnos[i]=new Alumnos("alumno"+(i+1),Math.random()*10+0 );
			arrAlumnos[i] = new Alumnos(LeerTeclado.readString(),
	...
	public static void visualizar(Alumnos[] x) {
	...
	static void ordenar(Alumnos[] array) {
		Alumnos aux;
