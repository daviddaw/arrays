...
public class Departamento {
	...
	public Departamento(int codigoDpto, String nombre, int numeroEmp) {
	    ...
	    //nombredelarray = new   tipo  [Longitud]
	...
	public Empleado buscarEmp (int codEmp){		
	...
	public void borrarEmp (Empleado emp){ //se pone a null la componente del array que viene indicada por el codigo de empleado
